...
<page-query>
  query  {
    recent: allBlogPost(sortBy: "date", order: DESC, limit: 3) {
      edges {
        node {
          id
          title
    ...
    other: allBlogPost(sortBy: "date", order: DESC, skip: 3, limit: 12) {
      edges {
        node {
          id
          title
    ...
    daily: allBlogPost(sortBy: "date", order: DESC, limit: 1) {
      edges {
        node {
          id
          title
